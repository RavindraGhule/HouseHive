...
import com.househive.HouseHiveApp;
import com.househive.config.AsyncSyncConfiguration;
import com.househive.config.EmbeddedSQL;
...
@SpringBootTest(classes = { HouseHiveApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
